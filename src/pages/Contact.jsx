  ...
  const contactMethods = [
    {
      ...
      title: "Call Us",
      detail: "07078966512",
      desc: "Available 9 AM - 9 PM daily",
    ...
    },
    {
      icon: FaEnvelope,
      title: "Email Us",
      detail: "support@naijakitchen.com",
    ...
    },
    {
      ...
      desc: "Our main kitchen location",
      color: "text-red-600",
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {contactMethods.map((method, idx) => (
            <div
              key={idx}
              className={`${method.bg} p-6 rounded-xl shadow-md hover:shadow-xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 animate-fade-in-up text-center`}
          ...
          <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg space-y-6">
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: "0s" }}>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white rounded-lg focus:border-green-600 focus:outline-none transition hover:border-gray-400"
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
              ...
              <textarea
                ...
                required
                rows="6"
                className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white rounded-lg focus:border-green-600 focus:outline-none transition hover:border-gray-400 resize-none"
            ...
            <button
              type="submit"
              className="w-full py-4 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg font-bold text-lg hover:from-green-700 hover:to-green-800 hover:scale-105 transition-all duration-300 shadow-lg flex items-center justify-center gap-2 animate-fade-in-up"
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            <div
              key={idx}
              className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 animate-fade-in-up"
              style={{ animationDelay: `${idx * 0.1}s` }}
            >
