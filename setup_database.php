<?php
// Database setup script - Run this once to create tables and insert data
...
try {
    ...
    // Insert sample foods
    $insertSql = "
    INSERT IGNORE INTO foods (name, price, category, description, image_url) VALUES
    ...
    $pdo->exec($insertSql);
    echo "Sample foods inserted.<br>";

    echo "<strong>Database setup complete!</strong><br>";
    echo "You can now use your e-commerce app.";
